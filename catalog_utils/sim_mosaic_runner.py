...
datadir = '/Users/j.mccleary/Research/jwst_cosmos/mock_data/COSMOS2020_sims/DEC2022_v0.0.4/sim_mosaics_working'
f115w_catalog_name = 'mosaic_nircam_f115w_COSMOS-Web_i2d_valid_starcat.fits'
f115w_catalog = catalog(os.path.join(datadir, f115w_catalog_name))

f150w_catalog_name = 'mosaic_nircam_f150w_COSMOS-Web_i2d_valid_starcat.fits'
f150w_catalog = catalog(os.path.join(datadir, f150w_catalog_name))

f277w_catalog_name = 'mosaic_nircam_f277w_COSMOS-Web_i2d_valid_starcat.fits'
f277w_catalog = catalog(os.path.join(datadir, f277w_catalog_name))

f444w_catalog_name = 'mosaic_nircam_f444w_COSMOS-Web_i2d_valid_starcat.fits'
f444w_catalog = catalog(os.path.join(datadir, f444w_catalog_name))

bandpasses = ['F115W', 'F150W', 'F277W', 'F444W']
band_catalogs=[f115w_catalog, f150w_catalog, f277w_catalog, f444w_catalog]
...
columns = ['Filter', 'PSFex_Avg_Reduced_Chisq', 'PSFex_STD_Reduced_Chisq',
           'PSFex_Median_Reduced_Chisq', 'PSFex_MAE', 'PSFex_MAE_STD',
           'PSFex_MRE', 'PSFex_MRE_STD','ShOpt_Avg_Reduced_Chisq',
           'ShOpt_STD_Reduced_Chisq', 'ShOpt_Median_Reduced_Chisq',
           'ShOpt_MAE', 'ShOpt_MAE_STD', 'ShOpt_MRE', 'ShOpt_MRE_STD'
           ]
df = pd.DataFrame(columns=columns)

for band, bandcat in zip(bandpasses, band_catalogs):
    pass
...
mean_relative_error_plot_psfex.set_titles([
    f'Median Star F115W', f'Median PSFex PSF',
    f'MRE = {round(sum_residuals_mre_psfex,2)} +/- {round(std_mr_psfex, 2)}'
    ])
mean_relative_error_plot_psfex.save_figure(
    outname="f115w_sim_mosaic_mre_psfex.png",
    vminscale=1, vmaxscale=1, linthresh=0.2
    )
...
mean_relative_error_plot_shopt.save_figure(outname="f115w_sim_mosaic_mre_shopt.png")
"""
...
mean_chi2_plot_psfex.set_titles([
    f'Median Star F115W', f'Median PSFex PSF',
    r'$\overline{\chi^2}$' + \
    f' = {round(reduced_chi2_psfex, 2)} +/- {round(std_chi_psfex,2)}'
    ])
mean_chi2_plot_psfex.save_figure(
    outname="f115w_sim_mosaic_chi2_psfex.png",
    vminscale=1, vmaxscale=1, linthresh=0.2
    )
chi_square_visit_psfex += \
    [element for element in mean_chi2_plot_psfex.return_chi2_vals()]
...
mean_chi2_plot_shopt.save_figure(outname="f115w_sim_mosaic_chi2_shopt.png")
...
std_abs_psfex = mean_absolute_error_plot_psfex.sem
mean_absolute_error_plot_psfex.set_titles([
    'Median Star F115W', 'Median PSFex PSF',
    f'MAE = {round(sum_residuals_abs_psfex,2)} +/- {round(std_abs_psfex,2)}'
    ])
mean_absolute_error_plot_psfex.save_figure(
    outname="f115w_sim_mosaic_abs_psfex.png",
    vminscale=1, vmaxscale=1, linthresh=0.2
    )
...
std_abs_shopt = mean_absolute_error_plot_shopt.return_residuals_sem()
mean_absolute_error_plot_shopt.set_titles([
    'Median Star F115W', 'Median ShOpt PSF',
    f'MAE = {round(sum_residuals_abs_shopt,2)} +/- {round(std_abs_shopt,2)}'
    ])
mean_absolute_error_plot_shopt.save_figure(
    outname="f115w_sim_mosaic_abs_shopt.png",
    vminscale=1, vmaxscale=1, linthresh=0.2
    )
...
mean_relative_error_plot_psfs.save_figure(outname="f150w_sim_mosaic_mre_psfex.png")
...
mean_relative_error_plot_shopt.save_figure(outname="f150w_sim_mosaic_mre_shopt.png")
...
mean_chi2_plot_psfs.save_figure(outname="f150w_sim_mosaic_chi2_psfex.png")
...
mean_chi2_plot_shopt.save_figure(outname="f150w_sim_mosaic_chi2_shopt.png")
chi_square_visit_shopt += [element for element in mean_chi2_plot_shopt.return_chi2_vals()]
...
std_abs_psfs = mean_absolute_error_plot_psfs.return_residuals_sem()
...
mean_absolute_error_plot_psfs.save_figure(outname="f150w_sim_mosaic_abs_psfex.png")
...
mean_absolute_error_plot_shopt.save_figure(outname="f150w_sim_mosaic_abs_shopt.png")
...
mean_relative_error_plot_psfex.save_figure(outname="f277w_sim_mosaic_mre_psfex.png")
...
mean_chi2_plot_psfex.save_figure(outname="f277w_sim_mosaic_chi2_psfex.png")
...
mean_chi2_plot_shopt.save_figure(outname="f277w_sim_mosaic_chi2_shopt.png")
chi_square_visit_shopt += [element for element in mean_chi2_plot_shopt.return_chi2_vals()]
...
mean_absolute_error_plot_psfex.save_figure(outname="f277w_sim_mosaic_abs_psfex.png")
...
mean_absolute_error_plot_shopt.save_figure(outname="f277w_sim_mosaic_abs_shopt.png")
...
mean_relative_error_plot_psfex.save_figure(outname="f444w_sim_mosaic_mre_psfex.png")
...
mean_chi2_plot_psfex.save_figure(outname="f444w_sim_mosaic_chi2_psfex.png")
chi_square_visit_psfex += [element for element in mean_chi2_plot_psfex.return_chi2_vals()]
...
mean_absolute_error_plot_psfex.save_figure(outname="f444w_sim_mosaic_abs_psfex.png")
...
df.to_csv('sim_mosaic_results.csv', index=False)
...
newaxs.legend()
newfig.savefig('apr_sim_mosaic_reduced_chi_square_distribution.png')
...
plt.tight_layout()
fig.savefig('apr_sim_mosaic_mean_comparison.png')
"""
